...
const std::vector<uint16_t> indices = {
    1, 2, 3, 3, 2, 4, 4, 2, 0, 0, 2, 1, 1, 3, 4, 4, 0, 1
};
...
private:
    ...
    void createCommandPool() {
        QueueFamilyIndices queueFamilyIncides = findQueueFamilies(physicalDevice);
        
        VkCommandPoolCreateInfo poolInfo{};
        poolInfo.sType = VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO;
        poolInfo.flags = VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT;
        poolInfo.queueFamilyIndex = queueFamilyIncides.graphicsFamily.value();
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("/Users/dylanjayasundera/Code/VulkanTesting/VulkanTesting/shaders/vert.spv");
        auto fragShaderCode = readFile("/Users/dylanjayasundera/Code/VulkanTesting/VulkanTesting/shaders/frag.spv");
        ...
        if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
            throw std::runtime_error("faied to create graphics pipeline!");
        }
